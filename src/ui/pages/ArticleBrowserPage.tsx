...
export function ArticleBrowserPage() {
  ...
  return (
    <div>
      <h1 className="mb-6 text-2xl font-semibold text-gray-900 dark:text-gray-100">Browse Articles</h1>
    ...
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
      {articles.map((article) => (
        <button
          ...
          className="rounded-lg border border-gray-200 bg-white p-5 text-left shadow-sm hover:border-blue-400 hover:shadow dark:border-gray-700 dark:bg-gray-900 dark:hover:border-blue-500"
        >
