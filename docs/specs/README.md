...
| Auth | [auth.md](auth.md) | Login, change password, admin user creation, JWT lifecycle (HS256, 24h, SSM secret) | [2026-04-26](../plans/completed/auth-acceptance-2026-04-26.md) |

## Partial Specs

| Spec | File | Summary | Acceptance Report |
|------|------|---------|---|
| Scripture Browsing | [scripture-browsing.md](scripture-browsing.md) | Browse Standard Works (Work → Book → Chapter), read verse lists, prev/next chapter nav | [2026-04-26](../plans/completed/scripture-browsing-acceptance-2026-04-26.md) |
